...
impl Actor {
    ...
    /// Translates the world coordinate system, which has Y pointing up and the origin at the
    /// center, to the screen coordinate system, which has Y pointing downward and the origin at
    /// the top-left.
